        ...
        <div class="card-body">
            <div class="media flex-wrap align-items-center">
                ...
                <div class="media-body" style="min-width: 180px">
                    Su suscripción finaliza el <strong> 20 de febrero de 2015</strong>
                </div>
                <div class="media-right mt-2 mt-xs-plus-0">
                    <a class="btn btn-success" href="fixed-student-account-billing-upgrade.html">Actualizar</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-header">
                    <div class="media align-items-center">
                        <div class="media-body">
                            ...
                            <p class="card-subtitle">Tus cursos recientes</p>
                        </div>
                        <div class="media-right">
                            <a class="btn btn-sm btn-primary" href="fixed-student-my-courses.html">Mis cursos</a>
                        </div>
                    </div>
                </div>
                ...
                <ul class="list-group list-group-fit mb-0" style="z-index: initial;">
                    ...
                    <li class="list-group-item" style="z-index: initial;">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex">
                                <a href="fixed-student-take-course.html" class="text-body"><strong>Learn Vue.js Fundamentals</strong></a>
                                <div class="d-flex align-items-center">
                    ...
                    <li class="list-group-item" style="z-index: initial;">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex">
                                <a href="fixed-student-take-course.html" class="text-body"><strong>Bootstrap Foundations</strong></a>
                                <div class="d-flex align-items-center">
                                    <div class="progress" style="width: 100px;">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="media align-items-center">
                        <div class="media-body">
                            <h4 class="card-title">
                                Cuestionarios</h4>
                            <p class="card-subtitle">Tu rendimiento</p>
                        </div>
                        <div class="media-right">
                            <a class="btn btn-sm btn-primary" href="#">Resultados</a>
                        </div>
                    </div>
                </div>
                ...
                <ul class="list-group list-group-fit mb-0">
                    ...
                    <li class="list-group-item">
                        <div class="media align-items-center">
                            <div class="media-body">
                                <a class="text-body" href="fixed-student-quiz-results.html"><strong>Title of quiz goes here?</strong></a><br>
                                <div class="d-flex align-items-center">
                    ...
                    <li class="list-group-item">
                        <div class="media align-items-center">
                            <div class="media-body">
                                <a class="text-body" href="fixed-student-quiz-results.html"><strong>Directives &amp; Routing</strong></a><br>
                                <div class="d-flex align-items-center">
                                    <small class="text-black-50 text-uppercase mr-2">Course</small>
                    ...
                    <li class="list-group-item">
                        <div class="media align-items-center">
                            <div class="media-body">
                                <a class="text-body" href="fixed-student-quiz-results.html"><strong>Responsive &amp; Retina</strong></a><br>
                                <div class="d-flex align-items-center">
                                    <small class="text-black-50 text-uppercase mr-2">Course</small>
        ...
        <div class="col-lg-5">
            <div class="card card-2by1">
                <div class="card-header">
                    ...
                    <p class="card-subtitle">Tus ultimos logros</p>
                </div>
                ...
                <div class="card-header">
                    <div class="media align-items-center">
                        <div class="media-body">
                            ...
                            <p class="card-subtitle">Últimos temas del foro &amp; respuestas</p>
                        </div>
                        <div class="media-right">
                            <a class="btn btn-sm btn-primary" href="fixed-student-forum.html"> <i class="material-icons">keyboard_arrow_right</i></a>
                        </div>
                    </div>
                </div>
                ...
                <ul class="list-group list-group-fit">
                    ...
                    <li class="list-group-item forum-thread">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <div class="d-flex align-items-center">
                                    <a href="fixed-student-profile.html" class="text-body"><strong>Luci Bryant</strong></a>
                                    <small class="ml-auto text-muted">5 min ago</small>
                                </div>
                                <a class="text-black-70" href="fixed-student-forum-thread.html">Am I learning the right way?</a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="list-group-item forum-thread">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <div class="d-flex align-items-center">
                                    <a href="fixed-student-profile.html" class="text-body"><strong>Magnus Goldsmith</strong></a>
                                    <small class="ml-auto text-muted">7 min ago</small>
                                </div>
                                <a class="text-black-70" href="fixed-student-forum-thread.html">Can someone help me with the basic Setup?</a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="list-group-item forum-thread">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <div class="d-flex align-items-center">
                                    <a href="fixed-student-profile.html" class="text-body"><strong>Katelyn Rankin</strong></a>
                                    <small class="ml-auto text-muted">12 min ago</small>
                                </div>
                                <a class="text-black-70" href="fixed-student-forum-thread.html">I think this is the right way?</a>
                            </div>
                        </div>
                    </li>
